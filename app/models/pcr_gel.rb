class PcrGel < ActiveRecord::Base
  ...
  accepts_nested_attributes_for :spcr_products, :tpcr_products, :fpcr_products, :pcr_gel_images
  ...
  attr_accessible :spcr_products_attributes, :tpcr_products_attributes, :fpcr_products_attributes, :pcr_gel_images_attributes
end
